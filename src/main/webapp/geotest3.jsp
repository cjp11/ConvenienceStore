...
<body>
   ...
   <div id="map" style="width: 5px; height: 5px;"></div>
...
src="//dapi.kakao.com/v2/maps/sdk.js?appkey=05e91b3448aa9a644d40f7ad8293b48d&libraries=services"></script> -->
                  ...
                  function displayMarker(place) {
                     ...
                     kakao.maps.event.addListener(marker, 'click',
                           function() {
                              ...
                              displayPlaceInfo(place).setContent(
                                    '<div style="padding:5px;font-size:12px;">'
                                          + place.place_name
                                          + '</div>');
                              infowindow.open(map, marker);
                              /*  console.log(place.place_name);
                               var placeName = document.getElementById('pn');
                                   placeName.value = place.place_name;
                               var rename = placeName.value.replace(/ /gi,'-');
                               console.log(rename);
                                             var result = document.getElementById('pn2');
                                  result.value = rename; */
                           });
                  }
   ...
   <form name="map_form" action="start.do" method="get">
      ...
      <hidden input type="text" name="address" id="adr"
         style="width: 200px;
         height: 25.98438px;" /> <p>편의점을 선택하세요</p>
         점포명: <input type="text" name="placeName" id="pn4"
         style="width: 200px; height: 25.98438px;" /><br> 
         주소: <input type="text" name="addr" id="pn3"
         style="width: 200px; height: 25.98438px;" />
